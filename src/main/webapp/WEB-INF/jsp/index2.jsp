...
<style>
    ...
    body {
        ...
        padding: 0;
        color:black;
        filter: contrast(1.2);  /* Ensures text is readable on a dark or detailed background */
    }
    ...
    .dropdown-content {
        ...
        border-radius: 5px;
        z-index: 1; /* Ensure dropdown displays on top */
    }
...
<!-- a href="/movieReportLanguageCustomer">Movie Report by language</a-->
<a href="/movieReport">Movie List</a> 
<!---- <a href="/">Movie Update</a-->
<a href="/showTimeReport">Show Report</a>
...
<div class="dropdown-content">
<a href="/movieReportLanguage"> Movie Report And Booking</a>
<a href="/movieBookings">Booking Details</a>
