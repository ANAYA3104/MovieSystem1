...
<head>
    ...
    <style>
        ...
        header {
            background-color: rgba(52, 58, 64, 0.8); /* Slight transparency for header */
            color: #ffffff;
            padding: 30px 0;
            text-align: center;
            font-size: 2em;
        ...
        footer {
            background-color: rgba(52, 58, 64, 0.8); /* Slight transparency for footer */
            color: #ffffff;
            padding: 15px 0;
            text-align: center;
            position: fixed;
