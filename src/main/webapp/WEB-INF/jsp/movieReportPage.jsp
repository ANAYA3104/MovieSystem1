    ...
    <div>
        ...
        <table border="2">
            <tr>
                ...
                <th>Rating</th>
                <th>Show Details</th>
                <th>ShowTime Update</th>
                <th>Movie Deletion</th>
                <th>Movie Updation</th>
            </tr>
            <c:forEach items="${movieList}" var="movie">
                <tr>
                    ...
                    <td><a href="/updateMovieShow/${movie.movieId}">Show Time Update</a></td>
                    <td><a href="/movieDeletion/${movie.movieId}">Movie Deletion</a></td>
                    <td><a href="/updateMovie/${movie.movieId}">Movie Update</a></td>
                </tr>
            </c:forEach>
        </table>
