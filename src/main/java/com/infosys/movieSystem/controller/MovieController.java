...
public class MovieController {
	...
	public ModelAndView showTimeReportPage() {
	    ...
	    if (role.equalsIgnoreCase("Admin")) {
                page = "showTimeReportPage";  // Admin's page
            } else if (role.equalsIgnoreCase("Customer")) {
                page = "showTimeReportCustomerPage";  // Customer's page
            }
	 ...
	 @PostMapping("/movieReportLanguage")
		public ModelAndView showMovieReportByLanguagePage(@RequestParam("languages") String language) {
		    ...
		    if ("Admin".equalsIgnoreCase(role)) {
		        page = "movieReportByLanguageAdminPage"; // Admin's JSP
		    } else if ("Customer".equalsIgnoreCase(role)) {
		        page = "movieReportByLanguageCustomerPage"; // Customer's JSP
		    } else {
